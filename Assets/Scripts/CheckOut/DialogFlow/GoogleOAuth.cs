...
public class GoogleOAuth : MonoBehaviour
{
    ...
    void Start()
    {
        StartCoroutine(Request(serviceAccountID +"@"+ projectID +".iam.gserviceaccount.com", Application.dataPath + "/Scripts/CheckOut/DialogFlow/" + p12Key));
    }
    ...
    IEnumerator Request(string serviceAccount, string p12Key)
    {
        ...
        Debug.Log("Finished Cloud Setup");
    }
